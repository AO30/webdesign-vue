  ...
  <div>
    <el-form :model="submitForm" class="sumbit" :rules="rules">
      ...
      <el-form-item label="权值" prop="value">
        <el-input v-model="submitForm.value" number></el-input>
      </el-form-item>
      <el-form-item label="最低分" prop="minGrade">
        <el-input v-model="submitForm.minGrade" number></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        value: [{ required: true, message: "请输入权值", trigger: "blur" }],
        minGrade: [{ required: true, message: "请输入最低分", trigger: "blur" }]
      },
      impForm: {
        cId: null,
        number: null,
